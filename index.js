...
// ПОЛУЧИТЬ ВСЕ ЗАПИСИ
//
// Используется для счетов и контрагентов.
// Отгрузки здесь НЕ используем.
// ============================================================
...
// ВАЖНО:
//
// 1. Только за указанный период
// 2. Только проведенные документы
//
// from / to приходят из формы отчета.
// ============================================================

async function getDemandsByDate(from, to) {
    ...
    //
    // Даже если API вернет что-то лишнее,
    // оставляем только проведенные отгрузки
    // --------------------------------------------------------
...
//
// ВАЖНО:
// Оставляем твою исходную логику.
//
...
async function buildDriverReport(
    ...
    // ВАЖНО:
    //
    // Теперь НЕ загружаем все отгрузки.
    //
    // Получаем только:
    //
    // from -> to
    ...
    for (
        ...
        //
        // ВАЖНО:
        // массив demands уже содержит только:
        //
        // applicable=true
        // from -> to
        //
        // Поэтому здесь не перебирается вся история.
        // ====================================================
        ...
        for (
            ...
            // ------------------------------------------------
            // ДОПОЛНИТЕЛЬНАЯ ПРОВЕРКА ПРОВЕДЕНИЯ
            // ------------------------------------------------
